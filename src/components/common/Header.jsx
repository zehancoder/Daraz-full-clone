          ...
          <Container className="relative h-full z-50">
            ...
            <div className="flex justify-between items-center gap-5 h-full md:h-28 max-w-5xl mx-auto font-roboto">
              ...
              <div className="flex md:hidden items-center gap-6">
                <Link to={"/login"} className="px-3 py-1 bg-gray-200 rounded-full ">
                  <p className="text-gray-600 font-[400] text-[14px] transition duration-300 hover:text-gray-500 uppercase">
                    Login
                  </p>
                </Link>
                <Link to={"/signup"}>
                ...
                <div onClick={toggleNav} >
                  <IoMenu className={`text-white font-bold  text-3xl cursor-pointer ${toggle ? 'hidden' : 'block'}`} />
                  <IoCloseSharp className={`text-white font-bold text-3xl cursor-pointer ${toggle ? 'block' : 'hidden'}`}/>
                </div>
              </div>
            </div>
          </Container>
